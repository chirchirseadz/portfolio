...
<div class="text-center">
    <div class="author-img" style="background-image: url({{asset('images/sydneyimg.jpeg')}});"></div>
    <h1 id="colorlib-logo"><a href="index.html">Sydney Kipchirchir</a></h1>
    <span class="position"><a href="#">Software developer</a> KE</span>
</div>
